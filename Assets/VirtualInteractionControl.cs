...
namespace Choi.MyProj.UI
{
	public class VirtualInteractionControl : PointerInputModule
	{
		...
		void CanvasObjectLook()
		{
			...
			if (CurrentRaycast.gameObject != null) Debug.Log($"CanvasObjectLook() : {CurrentRaycast.gameObject.name}");
		...
		void HandleSelection()
		{
			...
			//if (handler != null) Debug.Log($"HandleSelection() Look And Catched : {handler.name}");
